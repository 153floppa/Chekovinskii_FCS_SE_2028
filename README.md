...
2. **Собственник не видит потенциал редевелопмента** — например, большой банк на "красной линии" можно выселить, разделить на 4 меньших помещения и заселить супермаркет, салон красоты, табачный киоск и т.д. Такие небольшие помещения часто сдаются дороже, чем одно большое. Чуть ниже график с доказательством этого факта будет
...
На графике изображена зависимость стоимости кв метра недвиги от ее общей площади.
![plot.png](plot.png)
---
